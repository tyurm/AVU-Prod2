codeunit 82006 "AVU Map VAT Curr. Exch. Rate"
{
    TableNo = "Data Exch.";

    trigger OnRun()
    var
        CurrencyExchangeRate: Record "AVU Add. VAT Exchange Rate";
    begin
    ...
    procedure MapCurrencyExchangeRates(DataExch: Record "Data Exch."; var CurrencyExchangeRate: Record "AVU Add. VAT Exchange Rate")
    var
    ...
    local procedure UpdateCurrencyExchangeRate(var CurrencyExchangeRate: Record "AVU Add. VAT Exchange Rate"; DefinitionDataExchField: Record "Data Exch. Field"): Boolean
    var
        RecordRef: RecordRef;
    begin
    ...
    begin
        ...
        if DataExchField.FindFirst then begin
            CheckAndSetVatLCY(FieldNo, DataExchField);
            exit(true);
        end;
    ...
    begin
        ...
        DataExchFieldMapping.SetRange("Table ID", DATABASE::"AVU Add. VAT Exchange Rate");
    ...
    var
        CurrencyExchangeRate: Record "AVU Add. VAT Exchange Rate";
    begin
        InsertMandatoryField(TempField, CurrencyExchangeRate.FieldNo("Currency Code"), DATABASE::"AVU Add. VAT Exchange Rate");
        InsertMandatoryField(TempField, CurrencyExchangeRate.FieldNo("Relational Exch. Rate Amount"), DATABASE::"AVU Add. VAT Exchange Rate");
    end;
    ...
    var
        CurrencyExchangeRate: Record "AVU Add. VAT Exchange Rate";
    begin
        InsertMandatoryField(TempField, CurrencyExchangeRate.FieldNo("Starting Date"), DATABASE::"AVU Add. VAT Exchange Rate");
        InsertMandatoryField(TempField, CurrencyExchangeRate.FieldNo("Exchange Rate Amount"), DATABASE::"AVU Add. VAT Exchange Rate");
    end;
    ...
    local procedure CheckAndSetVatLCY(FieldNo: integer; var DataExchField: Record "Data Exch. Field")
    var
        GLSetup: Record "General Ledger Setup";
    begin
        GLSetup.Get();

        if (FieldNo = 1) and (UpperCase(DataExchField.Value) = GLSetup."LCY Code") then
            DataExchField.Value := GLSetup."AVU LCY Curr. for VAT Rep.";
    end;
}
