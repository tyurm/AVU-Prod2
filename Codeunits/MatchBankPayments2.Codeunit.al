codeunit 82007 "Match Bank Payments 2"
{
    ...
    begin
        ...
        if BankAccReconciliationLine.findset then
            repeat
                DeleteAppliedPaymentEntries(BankAccReconciliation, BankAccReconciliationLine);
                DeletePaymentMatchDetails(BankAccReconciliation, BankAccReconciliationLine);
    ...
    begin
        ...
        then begin
            ...
            if TRUE OR //(not CHMgt.IsESRFormat(BankAccReconciliationLine."ESR Reference No.")) or
    ...
    begin
        ...
        //     if StrPos(SearchText, DocNo) = StrLen(SearchText) - StrLen(DocNo) then
        //         BankPmtApplRule."Doc. No./Ext. Doc. No. Matched" := BankPmtApplRule."Doc. No./Ext. Doc. No. Matched"::Yes;
        //     exit;
        // end;
    ...
    local procedure DeletePaymentMatchDetails(BankAccReconciliation: Record "Bank Acc. Reconciliation"; var BankAccReconciliationLine: Record "Bank Acc. Reconciliation Line")
    var
        PaymentMatchingDetails: Record "Payment Matching Details";
    begin
    ...
    local procedure DeleteAppliedPaymentEntries(BankAccReconciliation: Record "Bank Acc. Reconciliation"; var BankAccReconciliationLine: Record "Bank Acc. Reconciliation Line")
    var
        AppliedPaymentEntry: Record "Applied Payment Entry";
    begin
    ...
    begin
        ...
        if not TempBankStatementMatchingBuffer.FindFirst then
            exit;
